...
function render() {
    ...
    gl.uniform4f(inputColorLocation, 1.0, 0.5, 0.0, 1.0);
    gl.drawArrays(gl.TRIANGLES, 0, 3); // draw the triangle

    gl.uniform4f(inputColorLocation, 0.0, 0.0, 1.0, 1.0);
    gl.drawArrays(gl.LINE_LOOP, 0, 3);

    gl.uniform4f(inputColorLocation, 1.0, 0.0, 0.0, 1.0); // red color
